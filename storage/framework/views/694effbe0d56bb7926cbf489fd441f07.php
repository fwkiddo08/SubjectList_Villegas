...
<div class="card mb-3">
    <div class="card-body py-3">
        <form method="GET" action="<?php echo e(route('departments.index')); ?>" class="row g-2 align-items-end">
            <div class="col-12 col-md-5">
                <div class="search-bar">
                    <i class="bi bi-search"></i>
                    <input type="text" name="search" class="form-control"
                        placeholder="Search name, code, head…" value="<?php echo e(request('search')); ?>">
                </div>
            </div>
...
<div class="card">
    <div class="card-header">
        ...
        <span class="badge bg-warning-subtle text-warning ms-2"><?php echo e($departments->total()); ?></span>
    </div>
    <div class="table-wrapper">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-muted"><?php echo e($departments->firstItem() + $i); ?></td>
                    <td><code><?php echo e($dept->code); ?></code></td>
                    <td>
                        <div class="fw-semibold"><?php echo e($dept->name); ?></div>
                    ...
                    <td><?php echo e($dept->head ?? '—'); ?></td>
                    <td>
                        <span class="badge bg-primary-subtle text-primary">
                            <?php echo e($dept->subjects_count); ?>

                        </span>
                    </td>
                    <td>
                        <span class="badge bg-<?php echo e($dept->status === 'active' ? 'success' : 'danger'); ?>-subtle
                              text-<?php echo e($dept->status === 'active' ? 'success' : 'danger'); ?>">
                            <?php echo e(ucfirst($dept->status)); ?>

                        </span>
                    </td>
                    <td class="text-muted" style="font-size:12px"><?php echo e($dept->created_at->format('M d, Y')); ?></td>
                    <td>
                        <div class="d-flex gap-1">
                            ...
                            <form id="del-dept-<?php echo e($dept->id); ?>"
                                action="<?php echo e(route('departments.destroy', $dept)); ?>"
                                method="POST" style="display:inline">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button type="button"
                                    class="btn btn-icon btn-outline-danger btn-sm"
                                    title="Delete"
                                    onclick="confirmDelete('del-dept-<?php echo e($dept->id); ?>', '<?php echo e(addslashes($dept->name)); ?>')">
    ...
    <div class="card-body pt-0 d-flex justify-content-between align-items-center">
        <span class="text-muted" style="font-size:13px">
            Showing <?php echo e($departments->firstItem()); ?>–<?php echo e($departments->lastItem()); ?> of <?php echo e($departments->total()); ?>

        </span>
        <?php echo e($departments->withQueryString()->links('pagination::bootstrap-5')); ?>
        ...
        <div class="modal-content">
            <form action="<?php echo e(route('departments.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('departments._form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('departments._form', ['edit' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Kerby\OneDrive\Documents\schoolapp\resources\views\departments\index.blade.php ENDPATH**/ ?>