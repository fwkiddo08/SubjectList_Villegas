...
<div class="page-header">
    <div>
        <h1>Subject List</h1>
        <p><?php echo e(auth()->user()->isStudent() ? 'Browse subjects assigned to your department.' : 'Manage all academic subjects across departments.'); ?></p>
    </div>
...
<div class="card mb-3">
    <div class="card-body py-3">
        <form method="GET" action="<?php echo e(route('subjects.index')); ?>" class="row g-2 align-items-end">
            ...
            <?php else: ?>
                <input type="hidden" name="department_id" value="<?php echo e(auth()->user()->department_id); ?>">
                <div class="col-6 col-md-2">
                    <div class="form-control bg-white text-muted" style="height:44px; display:flex; align-items:center; border:1px solid #d1d5db; border-radius:.375rem;">
                        <?php echo e(auth()->user()->department?->name ?? 'Unassigned'); ?>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route('subjects.show', $subject)); ?>" class="btn btn-icon btn-outline-secondary btn-sm" title="View Details">
                                <i class="bi bi-eye"></i>
                            </a>
                            <?php if(auth()->user()->isAdmin()): ?>
