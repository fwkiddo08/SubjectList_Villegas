        ...
        <div class="card mb-3">
            <div class="card-body text-center p-4">
                ...
                <?php if($user->student_number): ?>
                    ...
                    <div class="fw-semibold mb-3"><?php echo e($user->student_number); ?></div>
                <?php endif; ?>

                <?php if($user->department): ?>
                    <div class="text-muted mb-2" style="font-size:13px">Department</div>
                    <div class="fw-semibold mb-3"><?php echo e($user->department->name); ?></div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="student_number" class="form-control <?php $__errorArgs = ['student_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('student_number', $user->student_number)); ?>">
