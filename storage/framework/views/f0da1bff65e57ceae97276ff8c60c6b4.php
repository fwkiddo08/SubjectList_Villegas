...
unset($__errorArgs, $__bag); ?>"
    ...
    <p class="text-center mb-0" style="font-size:14px;color:#64748b">
        ...
        <a href="<?php echo e(route('register')); ?>" class="auth-link">Create one for free</a>
    </p>

    <div class="mt-4 p-3 rounded-2" style="background:#f8fafc;border:1px solid #e2e8f0">
        <p class="mb-1" style="font-size:12px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.5px">Demo Credentials</p>
        <p class="mb-0" style="font-size:12px;color:#64748b">
            Admin: <code>admin@schoolsys.com</code> / <code>password</code><br>
            Student: <code>maria@schoolsys.com</code> / <code>password</code>
        </p>
    </div>
