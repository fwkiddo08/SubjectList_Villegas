...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — SchoolSys</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="nav-link-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                <i class="bi bi-grid-1x2-fill"></i> Dashboard
            </a>
            <?php endif; ?>

            <div class="nav-section-label">Academic</div>
            <a href="<?php echo e(route('subjects.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('subjects.*') ? 'active' : ''); ?>">
                <i class="bi bi-journal-text"></i> Subjects
            </a>
            <?php if(auth()->user()->isAdmin()): ?>
            <a href="<?php echo e(route('departments.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('departments.*') ? 'active' : ''); ?>">
                <i class="bi bi-building"></i> Departments
            </a>
            <?php endif; ?>

            <div class="nav-section-label">Account</div>
            <a href="<?php echo e(route('profile.show')); ?>" class="nav-link-item <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
                <i class="bi bi-person-circle"></i> My Profile
            </a>
        </nav>

        <div class="sidebar-footer">
            <a href="<?php echo e(route('profile.show')); ?>" class="user-card text-decoration-none">
                <div class="user-avatar">
                    <?php if(auth()->user()->avatar && file_exists(public_path('uploads/avatars/' . auth()->user()->avatar))): ?>
                        <img src="<?php echo e(asset('uploads/avatars/' . auth()->user()->avatar)); ?>" alt="">
                    <?php else: ?>
...
<?php /**PATH C:\Users\Kerby\OneDrive\Documents\schoolapp\resources\views/layouts/app.blade.php ENDPATH**/ ?>